...
;(function ($, window, document, undefined) {
  var pluginName = "countdown360",
      defaults = {
        ...
        label: ["sekunda", "sekund","sekundy"],    // the label to use or false if none
  ...
  Plugin.prototype = {
    ...
    _drawCountdownLabel: function (secondsElapsed) {
      ...
      var label = this.settings.label[1];
      if (secondsLeft === 1) {
        label = this.settings.label[0];
      } else if (secondsLeft === 2 || secondsLeft === 3 || secondsLeft === 4) {
        label = this.settings.label[2];
      }
      var    drawLabel = this.settings.label && this.settings.label.length === 3,
